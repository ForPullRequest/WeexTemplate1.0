<template>
    <base title="column" @baseAppear="onappear">
        <columnview :items="deptList" :leftSelectionWidth="250" :borderLeftWidth="4" @itemSelect="onitemclick">
            <!-- myWidth必须要填 为了iOS中的显示问题 -->
            <tsl-refresh-list class="list white" ref="mlist" :hasData="list.length!=0" :hasMore="items[index].page_no >= items[index].total_page" :myWidth="500" @mload="load" @mrefresh="refresh">
