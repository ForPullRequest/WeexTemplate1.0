    ...
    <div>
        ...
        <list-item class="itemDiv" v-if="type=='text'">
            <div class="form">
                ...
                <text class="title" :style="{color:titleColor}" :value="title"></text>
                <text class="text" :style="{color:textColor,'text-align':isLeft?'left':'right','lines':lines}" :type="inputType" :value="textValue"></text>
            </div>
        </list-item>
        <!-- input -->
        <list-item class="itemDiv" v-if="type=='input'">
            <div class="form">
                <text class="require" :style="{visibility:ifRequire?'visible':'hidden'}">*</text>
                <text class="title" :style="{color:titleColor}" :value="title"></text>
                <input class="input" :style="{color:textColor,'text-align':isLeft?'left':'right'}" v-if="!isBelow" :type="inputType" :value="textValue" @input="input" :placeholder="placeholder"></input>
            </div>
            <input class="input" v-if="isBelow" :style="{color:textColor,'text-align':isLeft?'left':'right'}" :type="inputType" :value="textValue" @input="input" :placeholder="placeholder"></input>
        </list-item>
        <!-- textarea -->
        <list-item class="itemDiv" v-if="type=='textarea'">
            <div class="form">
                <text class="require" :style="{visibility:ifRequire?'visible':'hidden'}">*</text>
                <text class="title" :style="{color:titleColor}" :value="title"></text>
                <textarea class="textarea" :style="{color:textColor}" v-if="!isBelow" :type="inputType" :value="textValue" @input="input" :placeholder="placeholder"></textarea>
            </div>
            <textarea class="textarea" v-if="isBelow" :style="{color:textColor}" :type="inputType" :value="textValue" @input="input" :placeholder="placeholder"></textarea>
        </list-item>
        <!-- 图片选择 -->
        ...
        <list-item class="itemDiv" v-if="type=='dropdown'">
            ...
            <dropdown ref="dropdownList" :items="list" :textColor="titleColor" class="dropdowm-list" tag="tag" @dd_itemClick="itemClick"></dropdown>
        </list-item>
    </div>
</template>
